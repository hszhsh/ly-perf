...
export type SurfaceFlingerValueMode = "warmup" | "timeline" | "snapshot" | "unavailable";
...
export interface LyPerfApi {
  ...
  listInstalledApps: (serial: string, keyword?: string) => Promise<InstalledApp[]>;
  ...
  renameSession: (sessionId: string, displayName: string) => Promise<SessionDetail>;
  deleteSession: (sessionId: string) => Promise<void>;
  exportSession: (sessionId: string, format: "html" | "xlsx") => Promise<ExportResult>;
}
